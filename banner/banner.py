...
def banner():
    os.system("clear")
    # Nuevo Banner con el estilo y colores actualizados
    print(f"""
{WHITE}❰-----------------------------------------------------------------------❱{ENDC}
      ...
      {FAIL}╚███╔███╔╝██║██║     ██║       {OK}██║  ██║██║  ██║╚██████╗██║  ██╗{ENDC}
      {FAIL} ╚══╝╚══╝ ╚═╝╚═╝     ╚═╝       {OK}╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝{ENDC}
                            {FAIL}---< {WHITE}Creador: {OK}Takizawa {FAIL}>---{ENDC} 
{WHITE}      HERRAMIENTA DE AUDITORÍA WIFI (Reaper 2)      {ENDC}
{WHITE}❰-----------------------------------------------------------------------❱{ENDC}
""")
    # Opciones de menú (Sin cambios en funcionalidad, solo en el diseño del Banner)
